...
<head>
    ...
    <!--CUSTOM BASIC STYLES-->
    <link href="{{asset('public/assets/css/basic.css')}}" rel="stylesheet" />
    <!--CUSTOM MAIN STYLES-->
    ...
    <div id="wrapper ">
        ...
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            ...
            <div class="header-right">
                ...
                <div class="btn-group">
                                        <button class="btn btn-info"><small>Welcome,</small>
                                    </button>
                                        <button data-toggle="dropdown" class="btn btn-info dropdown-toggle"><span class="caret"></span></button>
                                        <ul class="dropdown-menu">
                                            
                                            <li><a href="{{url('api/logout')}}">Logout</a></li></ul>
                                        </div>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="{{URL::to('api/index') }}"><i class="fa fa-dashboard "></i>Dashboard</a>
                    </li>
                    <li>
                        <a href=""><i class="fa fa-desktop "></i>User <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level">
                            <li>
                                <a href="{{URL::to('api/user/index') }}"><i class="fa fa-toggle-on"></i>Users</a>
                            </li>
                            <li>
                                <a href="{{URL::to('api/addUser') }}"><i class="fa fa-bell "></i>AddUser</a>
                            </li>
